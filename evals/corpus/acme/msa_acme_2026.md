# Master Services Agreement — ACME and DocuMind Technologies
...
Either party may terminate for convenience on 90 days written
...
Aggregate liability is capped at Rs 50,00,000 or the fees paid in
the preceding 12 months, whichever is lower.

## MSA-09 — Service levels

The service target is 99.5% monthly availability, measured on
successful responses to /v1/query. Service credits are the sole remedy.

## MSA-12 — Data residency

ACME data is processed and stored in India (asia-south1). Sub-processors
