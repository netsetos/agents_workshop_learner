"""Lesson 13.1 / s2: Before you run anything: set up the shell
...
HTML instruction: bash — run in the operator shell when you finish the lesson, not now
...
Source: https://github.com/netsetos/agents_workshop/blob/main/lessons/13-operations/13.1-debug-wrong-answer/Netsetos_GCP_Capstone_13.1_Debug_Wrong_Answer_WIX.html#L410
