"""Lesson 13.2 / s5: Reconcile the view with make usage

Summary and purpose:
Do it

HTML instruction: bash — run in the operator shell, in the kit (reads only: Cloud Logging and one small BigQuery query)
Category: required. Read the matching README checkpoint before Run.
Prerequisites: demo_04_01_do_it
Expected observation: today since 00:00 IST: 4 usage rows in Cloud Logging, 2 tenant_daily rows
...
Source: https://github.com/netsetos/agents_workshop/blob/main/lessons/13-operations/13.2-usage-reconcile/Netsetos_GCP_Capstone_13.2_Usage_Reconcile_WIX.html#L607
