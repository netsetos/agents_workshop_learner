"""Lesson 16.1 / s5: The clip at its second

Summary and purpose:
Do it

HTML instruction: bash — run in the operator shell, in the kit (golden row mm-03's question, as the UI asks it)
Category: required. Read the matching README checkpoint before Run.
Prerequisites: demo_04_04_definition
Expected observation: 5 sources packed: [1] segment [2] figure [3] text [4] segment [5] text
...
[Clip 4]: the player opens townhall_2026_q1.mp4 at 00:22, the clip runs to 00:58; it holds the turn -> PASS
  ...
  https://storage.googleapis.com/documind-ai-YOUR-ID-uploads/acme/townhall_2026_q1.mp4?X-Goog-Algorithm=GOOG4-RSA-SHA256&X-Goog-Credential=documind-ui-sa%40documind-ai-YOUR-ID.iam.gserviceaccount.com%2F20260924%2Fauto%2Fstorage%2Fgoog4_request&X-Goog-Date=20260924T083000Z&X-Goog-Expires=900&X-Goog

Evidence: the active lesson session records this attempt and command output.
A completed process is not proof that every sample value matches your lane.
Source: https://github.com/netsetos/agents_workshop/blob/main/lessons/16-multimodal/16.1-video-clip/Netsetos_GCP_Capstone_16.1_Video_Clip_WIX.html#L694
