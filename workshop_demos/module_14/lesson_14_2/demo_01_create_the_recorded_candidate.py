"""Lesson 14.2: demo 01 create the recorded candidate
...
1. Create the recorded candidate (source window plan-1)
...
def step_01_create_the_recorded_candidate(session):
...
def demonstrate(session):
    ...
    run_steps(session, [
        ('source_demo_01_create_the_recorded_candidate', step_01_create_the_recorded_candidate),
