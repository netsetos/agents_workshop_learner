"""Lesson 9.1 / s4: The rows: what the context cache did to the bill

Summary and purpose:
Do it

HTML instruction: bash — run in the operator shell, in the kit (every acme usage row since the first ask; reads only)
Category: required. Read the matching README checkpoint before Run.
Prerequisites: demo_03_03_do_it_the_same_question_with_the_cache
...
Source: https://github.com/netsetos/agents_workshop/blob/main/lessons/09-caching/9.1-cache-compare/Netsetos_GCP_Capstone_9.1_Cache_Compare_WIX.html#L567
