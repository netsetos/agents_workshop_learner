"""Lesson 9.1: The rows: what the context cache did to the bill
...
Prerequisites: demo_03_the_context_cache_a_pack_a_cache_and_the_next_answer.
...
def step_01_the_rows_what_the_context_cache_did_to_the(session):
...
def demonstrate(session):
    ...
    """
    run_steps(session, [
        ('source_17', step_01_the_rows_what_the_context_cache_did_to_the),
