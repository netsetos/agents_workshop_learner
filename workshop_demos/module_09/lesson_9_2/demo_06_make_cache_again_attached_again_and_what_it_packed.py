"""Lesson 9.2: make cache again: attached again, and what it packed
...
Prerequisites: demo_05_the_corpus_moves_revision_2_and_both_caches_react.
...
# Original CLI workflow for step_01_make_cache_again_attached_again_and_what_i.
...
def step_01_make_cache_again_attached_again_and_what_i(session):
...
def demonstrate(session):
    ...
    """
    run_steps(session, [
        ('source_22', step_01_make_cache_again_attached_again_and_what_i),
