"""Lesson 8.2: The refusal ladder: the door, a 401 and a 403 side by side
...
# Original CLI workflow for step_01_the_refusal_ladder_the_door_a_401_and_a_40.
...
def step_01_the_refusal_ladder_the_door_a_401_and_a_40(session):
    ...
    Observe: no token                   403  (Cloud Run's own page: the request never reached the API)
...
def demonstrate(session):
    ...
    """
    run_steps(session, [
        ('source_8', step_01_the_refusal_ladder_the_door_a_401_and_a_40),
