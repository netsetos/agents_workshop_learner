"""Lesson 15.1: Build the handbook's graph
...
Prerequisites: demo_03_the_rules_run.
...
# Original CLI workflow for step_01_build_the_handbook_s_graph.
...
def step_01_build_the_handbook_s_graph(session):
    ...
    11 current text chunks for tenant 'acme' from 'hr_policy_2026.md'
    {"event": "graph_extracted", "tenant": "ac
    """
...
def demonstrate(session):
    ...
    """
    run_steps(session, [
        ('source_12', step_01_build_the_handbook_s_graph),
