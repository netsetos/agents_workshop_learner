"""Lesson 3.3: demo 03 reuse changed sections
...
5. Run it on the lane's text, Rs 0 (source window 44)

Prerequisites: demo_02_validate_embedding_stamps.
...
def step_05_on_the_lane_s_text_rs_0(session):
...
def demonstrate(session):
    ...
    run_steps(session, [
        ...
        ('source_44', step_05_on_the_lane_s_text_rs_0),
