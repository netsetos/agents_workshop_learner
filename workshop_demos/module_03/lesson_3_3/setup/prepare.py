"""Lesson 3.3: Before you run anything: set up the shell
...
COMMANDS_02 = """python -m pip install -q google-cloud-aiplatform google-genai && python -c "import google.cloud.aiplatform, google.genai; print('ok')"
