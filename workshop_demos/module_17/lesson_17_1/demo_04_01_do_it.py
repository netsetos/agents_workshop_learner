...
HTML instruction: bash — run in the operator shell, in the kit (every golden row, as in 7.2: about ten minutes)
...
Source: https://github.com/netsetos/agents_workshop/blob/main/lessons/17-tuning/17.1-tuning-decision/Netsetos_GCP_Capstone_17.1_Tuning_Decision_WIX.html#L542
...
COMMANDS = """make eval-live PROJECT="$PROJECT" REPORT="$HOME/gate171.json"
"""
