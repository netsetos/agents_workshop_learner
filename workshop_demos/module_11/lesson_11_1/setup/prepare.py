...
2. Do it: the venv (source window 8)
...
COMMANDS_02 = """[ -x ~/graph-venv/bin/python ] || python -m venv ~/graph-venv   # lesson 10.2's venv, made here if it is missing
