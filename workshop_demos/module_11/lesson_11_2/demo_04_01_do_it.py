"""Lesson 11.2 / s4: What your lane runs

Summary and purpose:
Do it

HTML instruction: bash — run in the operator shell, in the kit (what holds the conversations on your lane)
Category: required. Read the matching README checkpoint before Run.
Prerequisites: demo_03_02_do_it_two_turns
Expected observation: instance      documind-checkpoint: POSTGRES_16, db-f1-micro, zonal, 10 GB
  backups       off
...
Source: https://github.com/netsetos/agents_workshop/blob/main/lessons/11-memory/11.2-durable-storage/Netsetos_GCP_Capstone_11.2_Durable_Storage_WIX.html#L529
