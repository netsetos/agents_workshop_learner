...
2. Do it: fastmcp (source window 7)
...
# Original CLI workflow for step_02_fastmcp.
COMMANDS_02 = """python -m pip install -q "fastmcp==3.4.7" "uvicorn==0.52.4"   # the MCP image's pins, in the operator venv
python -c 'import fastmcp; print("fastmcp", fastmcp.__version__)'

"""

def step_02_fastmcp(session):
