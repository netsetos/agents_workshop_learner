...
| 2 | [demo_01_gate_and_reuse_plan.py](demo_01_gate_and_reuse_plan.py) | Run the handbook's offline gate and compare six edits through the worker's planner. |
| 3 | [demo_02_reissue_and_measure.py](demo_02_reissue_and_measure.py) | Upload revision 3 and inspect its ledger, claims and reused vectors. |
| 4 | [demo_03_failing_gate_and_undo.py](demo_03_failing_gate_and_undo.py) | Observe the expected live-gate failure, undo the revision and prove recovery. |
...
### demo_01_gate_and_reuse_plan.py
...
**`step_02_the_six_edits_through_the_worker_s_planner(session)` — Measure reuse: six kinds of edit, Rs 0 / Do it: the six edits through the worker's planner**
...
### demo_02_reissue_and_measure.py

Upload revision 3 and inspect its ledger, claims and reused vectors.

**`step_01_example(session)` — Do it: revision 3 of the handbook, on the lane / Do it**
...
**`step_02_read_the_three(session)` — Inspect: the ledger row, the claims, the vectors / Read the three**
...
### demo_03_failing_gate_and_undo.py
...
[Reading guide](GUIDE.md) retains explanatory prose and UI instructions from the [main HTML](https://github.com/netsetos/agents_workshop/blob/main/lessons/04-lifecycle/4.2-reindex/Netsetos_GCP_Capstone_4.2_Reindex_WIX.html). All 26 original windows are accounted for in `lesson_map.json`: executable steps, shared setup, or read-only examples. Reviewed source: `04da291943e43a6795223f296f39e4dafd0a5d8c`.
