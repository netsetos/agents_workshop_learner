...
Prerequisites: demo_04_the_comparison_with_the_actual_backends.
...
# Original CLI workflow for step_01_everything_off.
COMMANDS_01 = """make off PROJECT="$PROJECT"

"""

def step_01_everything_off(session):
...
def demonstrate(session):
    ...
    """
    run_steps(session, [
        ('source_17', step_01_everything_off),
