"""Lesson 18.2 / s4: The waits and the bill, from the kit

Summary and purpose:
Do it

HTML instruction: bash — run in the operator shell, in the kit (reads the kit's files; no network)
Category: required. Read the matching README checkpoint before Run.
Prerequisites: demo_03_02_do_it
Expected observation: the SLM: 1 nvidia-l4, 8 vCPU, 32Gi; 0 to 1 instance; 4 requests at a time; 600 s a request
...
Source: https://github.com/netsetos/agents_workshop/blob/main/lessons/18-serving/18.2-ollama-slm/Netsetos_GCP_Capstone_18.2_Ollama_SLM_WIX.html#L487
