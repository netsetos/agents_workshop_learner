...
INSTALL_LIVE_DEPENDENCIES = True  # False installs only the helpers for offline demo_01.
...
def main():
    ...
    print("Run demo_01 offline; then authenticate.py and check_setup.py before live demos.")
