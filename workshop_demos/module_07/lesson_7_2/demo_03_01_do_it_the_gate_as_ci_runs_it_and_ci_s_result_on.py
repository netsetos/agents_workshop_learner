...
HTML instruction: bash — run in the operator shell, in the kit (the offline half, as CI runs it)
...
Source: https://github.com/netsetos/agents_workshop/blob/main/lessons/07-evaluation/7.2-live-judge/Netsetos_GCP_Capstone_7.2_Live_Judge_WIX.html#L433
