"""Lesson 6.2: Before you run anything: set up the shell
...
def step_02_which_store_answers_acme_pin_it_to_the_kit(session):
    ...
    Example: Run this file after its README prerequisites, or set a breakpoint in this function.
    Observe: model: gemini-3.6-flash (default)  location: from the model: global for a name  base: none, no tuned endpoint
