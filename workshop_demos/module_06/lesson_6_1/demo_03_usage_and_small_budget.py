"""Lesson 6.1: demo 03 usage and small budget
...
2. The knob: a budget too small, on a candidate that takes no traffic (source window 34)

Prerequisites: demo_02_answer_cost_and_dated_evidence.
...
# Original CLI workflow for step_02_the_knob_a_budget_too_small_on_a_candidate.
...
def step_02_the_knob_a_budget_too_small_on_a_candidate(session):
...
def demonstrate(session):
    ...
    run_steps(session, [
        ...
        ('source_34', step_02_the_knob_a_budget_too_small_on_a_candidate),
