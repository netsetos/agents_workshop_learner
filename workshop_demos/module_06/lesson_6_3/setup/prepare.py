"""Lesson 6.3: Before you run anything: set up the shell
...
def step_02_which_store_answers_acme_pin_it_to_the_kit(session):
    ...
    Example: Run this file after its README prerequisites, or set a breakpoint in this function.
    Observe: guard: off (default)  template: documind-guard (default)  cache: off (default)  routing: off (default)  rerank timeout: 5.0 (default)
