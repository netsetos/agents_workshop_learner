"""Lesson 6.3 / s2: Before you run anything: set up the shell
...
Expected observation: guard: off (default)  template: documind-guard (default)  cache: off (default)  routing: off (default)  rerank timeout: 5.0 (default)
version: gemini-3.6-flash | documind-rag@v3 | semantic_cache off

Evidence: the active lesson session records this attempt and command output.
A completed process is not proof that every sample value matches your lane.
Source: https://github.com/netsetos/agents_workshop/blob/main/lessons/06-generation/6.3-streaming/Netsetos_GCP_Capstone_6.3_Streaming_WIX.html#L386
...
def demonstrate(session):
    ...
    """
    session.service_environment('documind-api', ['ARMOR', 'ARMOR_TEMPLATE', 'SEMANTIC_CACHE', 'ROUTING', 'RERANK_TIMEOUT_S'])
