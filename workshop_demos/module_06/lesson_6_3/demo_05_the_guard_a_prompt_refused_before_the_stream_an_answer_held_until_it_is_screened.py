"""Lesson 6.3: The guard: a prompt refused before the stream, an answer held until it is screened
...
Prerequisites: demo_04_what_a_stream_s_citations_are_and_the_streams_of_one_token.
